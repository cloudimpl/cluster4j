...
public final class Logger implements ILogger {
    ...
    /**
     * Log an information message. This will be added to the log file as "INFO"
     * line. Information messages are logged when application needs to write an
     * information line. This will not be popped up as an alert.
     *
    ...
    /**
     * Log an notification message. This will be added to the log file as
     * "NOTICE" line. Notification messages are logged when application needs to
     * write an information line which need to be notify to administrators. This
     * will be popped up as an alert.
     *
     * @param format the message format
     * @param args arguments
     */
    ...
    /**
     * Log an java {@link Exception} (or {@link Throwable}). This will be added
     * to the log file as "EXCEPTION" line. Exception messages are logged when
     * application needs to write an exception line which need to be notify to
    ...
    /**
     * Log an unexpected behavior but cannot be recovered automatically (i.e. an
     * error). This will be added to the log file as "ERROR" line. Error
     * messages are logged when application needs to write an error line which
     * need to be notify to administrators. This will be popped up as an alert.
     *
     * @param format the message format
     * @param args arguments
     */
    ...
    /**
     * Log an unexpected behavior but recovered automatically (i.e. an warning).
     * This will be added to the log file as "WARN" line. Warning messages are
     * logged when application needs to write an warning line which need to be
    ...
    /**
     * Log a debug message. This will be added to the log file as "DEBUG" line.
     * Debug messages are logged when application needs to write a debug
     * information line. This will not be popped up as an alert.
     *
     * @param format the message format
     * @param args arguments
    ...
    /**
     * Log more descriptive details. This will be added to the log file as
     * "VERB" line. Verbose messages are logged when application needs more
     * descriptive information for debugging purpose. This will not be popped up
     * as an alert.
     *
     * @param format the message format
     * @param args arguments
