...
public class IntBtree extends AbstractBTree{
    ...
    protected void fillIdxNode(long dstNodeIdx, long dstItemIdx, VarHandle itemHandler, long srcNodeIdx, long srcItemIdx) {
        int key = (int) itemHandler.get(address,srcNodeIdx,srcItemIdx);
    ...
    private int getKey(VarHandle itemHandler,int nodeIdx,int itemIdx)
    {
        return (int)itemHandler.get(this.address,nodeIdx,itemIdx);
    }
    ...
    public int getKey(int index) {
        ...
        return (int) this.keyItemHandler.get(this.address, nodeIdx, itemIdx);
    }
    
    protected int binarySearch(VarHandle itemHandler, int nodeIdx, int size, int key) {
        int low = 0;
        int high = size - 1;
