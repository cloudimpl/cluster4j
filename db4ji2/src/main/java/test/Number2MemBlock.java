...
import static test.NumberMemBlock.toJsonNumber;

/**
 *
 * @author nuwan
 */
public class Number2MemBlock implements NumberQueryBlock{
    ...
    public Number2MemBlock(ByteBuffer byteBuf, int offset, int pageSize) {
    ...
    public boolean put(LongBuffer temp,JsonNumber key, long value) {
        ...
        updateSize(size);
        this.size = size;
        double dkey = key.mantissa() * NumberQueryBlock.lookupTable2[exp];
    ...
    {       
        ...
        return Double.compare(leftMantissa * NumberQueryBlock.lookupTable2[leftExp],rightMantissa * NumberQueryBlock.lookupTable2[rightExp]);
    }
    ...
    public static void main(String[] args) {
        ...
        Number2MemBlock longBlock = new Number2MemBlock(alloc, 0, 4096);
